...
<!-- 					<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#avatar-modal" style="margin: 10px;">上传头像</button> -->
			...
			<form id="form1" class="form-horizontal" action="updateUserById" method="post">
				<input type="hidden" name="uId" id="uId" value="${user.uId}"/>
				<input type="hidden" name="uHeader" id="uHeader" />
				<div class="form-group">
					<label for="" class="col-md-2">用户名称</label>
					<div class="col-md-10">
						<input id="uName" name="uName" type="text" placeholder="请输入用户姓名" class="form-control" onchange="checkName()" value="${user.uName}"/>
					</div>
				</div>
				<div class="form-group">
