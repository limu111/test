...
<html>
	...
	<body>
		<div class="container">
			...
			<form id="form1" class="form-horizontal" action="insertUser" method="post">
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<input id="uPwd2" name="uPwd2" type="password" placeholder="再次输入密码" class="form-control" onchange="checkPwd()" />
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-md-2">用户角色</label>
					<div class="col-md-10">
				...
				<div class="form-group">
					<div class="col-md-10 col-md-offset-2">
						<input type="submit" value="注册" class="btn btn-success" id="addBtn" />
