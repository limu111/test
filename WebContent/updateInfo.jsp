...
<html>
	...
	<body>
		<div class="container">
			...
			<h2 class="page-header">发布101新闻</h2>
			<center>
			...
			<form id="form1" class="form-horizontal" action="insertInfo" method="post">
				<input type="hidden" name="iImg" id="iImg" />
				<div class="form-group">
					<label for="" class="col-md-2">姐姐名字</label>
					<div class="col-md-10">
						<input id="iName" name="iName" type="text" placeholder="输入101姐姐名字" class="form-control" onchange="checkName()" />
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-md-2">出生日期</label>
					<div class="col-md-10">
						<input id="iBirthday" name="iBirthday" type="text" placeholder="出生日期" class="form-control" />
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-md-2">个人简介</label>
					<div class="col-md-10">
						<textarea id="iInfo" name="iInfo" class="form-control">
						</textarea>
					</div>
				</div>
				<div class="form-group">
